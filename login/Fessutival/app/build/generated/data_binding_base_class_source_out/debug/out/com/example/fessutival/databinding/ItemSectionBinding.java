...
public final class ItemSectionBinding implements ViewBinding {
  ...
  private ItemSectionBinding(@NonNull LinearLayout rootView, @NonNull TextView sectionTitle) {
  ...
  public static ItemSectionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemSectionBinding((LinearLayout) rootView, sectionTitle);
    }
